...
-- Create Concert
INSERT INTO concert (name, place_id, created_at, updated_at)
VALUES ('Psy concert', @last_place_id, NOW(), NOW());
...
VALUES
    (@last_concert_id, @last_place_id, '2024-06-25', NOW(), NOW()),
    (@last_concert_id, @last_place_id, '2024-06-26', NOW(), NOW());
